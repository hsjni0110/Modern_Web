...
type Props = {
    ...
    active: string;
    index: number;
    handleClick: (something: any) => void;
}

const ExploreCard = ({ id, imgUrl, index, title, active, handleClick }: Props) => {
    return (
        <motion.div
    ...
    ease-out-flex cursor-pointer`}
        ...
        >
            ...
            {active !== id ? (
                ...
                <div className='absolute p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)]
                rounded-b-[24px] bottom-0'>
